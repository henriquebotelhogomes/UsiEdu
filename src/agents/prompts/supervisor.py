...
- **academico**: dúvidas sobre regimento, calendário acadêmico, datas de aulas, dias letivos, notas, faltas, matrícula, disciplinas, Ementas, grade curricular, estágio, TCC, trancamento, aproveitamento de estudos, reingresso, transferência interna, mobilidade acadêmica.
