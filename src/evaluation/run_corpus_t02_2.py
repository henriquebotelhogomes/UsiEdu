...
QUESTIONS = {
    "q018": "Qual o prazo para solicitacao de afastamento para pos-graduacao?",
    "q019": "Como solicitar adicional de insalubridade?",
    "q020": "Quais os direitos do servidor publico segundo a Lei 8.112?",
    "q021": "O que diz a norma sobre o horario de funcionamento da secretaria?",
    "q022": "Qual a politica institucional para uso dos laboratorios?",
}
...
def execute(qdrant_url: str) -> dict[str, Any]:
    ...
    return {
        ...
        "run_id": "t02-2-corpus-2026-08-11",
