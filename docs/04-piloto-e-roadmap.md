...
- [~] Visitante anônimo usa landing, login demo, chat, feedback e `/insights` por HTTPS. *(P0.2 em 2026-08-11 confirmou landing e `/health` públicos, mas o login demo retornou `Erro de autenticação`; chat, feedback e `/insights` não puderam ser aceitos.)*
