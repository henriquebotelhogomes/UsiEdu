...
- [~] Visitante anônimo usa landing, login demo, chat, feedback e `/insights` por HTTPS. *(baseline P0 de 2026-08-11 confirmou o ambiente Azure provisionado; a validação funcional HTTPS permanece pendente do runbook P0 ausente.)*
